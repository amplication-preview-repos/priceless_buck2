...
import { FriendGroup } from "../../friendGroup/base/FriendGroup";
...
export class UserResolverBase {
  ...
  async createUser(@graphql.Args() args: CreateUserArgs): Promise<User> {
    return await this.service.createUser({
      ...
      data: {
        ...
        friendGroup: args.data.friendGroup
          ? {
              connect: args.data.friendGroup,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => FriendGroup, {
    nullable: true,
    name: "friendGroup",
  })
  @nestAccessControl.UseRoles({
  ...
  async getFriendGroup(
    ...
    const result = await this.service.getFriendGroup(parent.id);
  ...
  async getTrip(@graphql.Parent() parent: User): Promise<Trip | null> {
